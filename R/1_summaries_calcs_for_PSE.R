...
write.csv(dat2, "output/Prov_runsize_1_20220729.csv", row.names=FALSE)
...
write.csv(dat5, "output/Prov_runsize_2_20220729.csv", row.names=FALSE)
...
write.csv(dat8, "output/Reg_runsize_1_20220729.csv", row.names=FALSE)
